 ...
 *
 */
public class CalculatorActivity extends SherlockActivity implements OnClickListener{
...
public boolean onCreateOptionsMenu(Menu menu) {
   ...
   //will be called when a menu item is selected
    ...
    public boolean onOptionsItemSelected(com.actionbarsherlock.view.MenuItem item) {
    	...
    	case R.id.icLog:
    					Intent intent=new Intent(CalculatorActivity.this,LogDisplayActivity.class);
  ...
  //method for handling the click event of various digit buttons
    ...
    //replace the previous operator in case or repeated clicking of operators
    ...
    /*if there is any previous operation to be carried out
    ...
    /*
     * convert the string entered to number 
     */
    ...
    /*
     * Method to store valid expressions in database
     */
    public void storeExpr()
    {
    	if(exprValidity)
    	{
    		ExprnDataSource eds=new ExprnDataSource(CalculatorActivity.this);
    		long timeStamp=System.currentTimeMillis();
    		eds.addExpr(expression, timeStamp);
    		Toast.makeText(this, getString(R.string.expression_saved_status), Toast.LENGTH_SHORT).show();
    	}
    }
    ...
    public void onClick(View v) {   
    	...
    	case R.id.btmultip:if(runmode==EXPMODE)
							{
    							clearSyntaxError(temp);
								text.setText(text.getText().toString()+MULTIPLY);
								decstatus=0;
								break;
							}
    					if(prevOp=='/')
    	...
    	case R.id.btmode:if(runmode==EXPMODE)
						{
    						clearSyntaxError(temp);
							text.setText(text.getText().toString()+MODE);
							decstatus=0;
							break;
						}
    					if(prevOp=='/')
		...
		default:Toast.makeText(CalculatorActivity.this, getString(R.string.select_valid_option), Toast.LENGTH_SHORT).show();
    	}  	
		}
